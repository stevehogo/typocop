...
src/
  indexer/
    phase2-symbol-extraction.ts
    phase2-symbol-extraction.test.ts   # unit + property tests
  query/
    execute-query.ts
...
|----------|------|-----------|
| 1: Symbol Uniqueness | `phase2-symbol-extraction.test.ts` | Req 4.1, 4.3 |
| 2: Relationship Validity | `phase3-resolution.test.ts` | Req 5.5, 5.7 |
| 3: Symbol Location Validity | `phase2-symbol-extraction.test.ts` | Req 4.4, 4.5 |
| 4: Cluster Confidence Bounds | `phase4-clustering.test.ts` | Req 6.2 |
| 5: Cluster Minimum Size | `phase4-clustering.test.ts` | Req 6.4 |
| 6: Cluster Symbol Validity | `phase4-clustering.test.ts` | Req 6.5 |
| 7: Process Step Ordering | `phase5-processes.test.ts` | Req 7.4 |
| 8: Process Minimum Length | `phase5-processes.test.ts` | Req 7.6 |
...
| 14: Embedding Dimensionality | `phase6-search.test.ts` | Req 8.3 |
