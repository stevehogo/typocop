...
- [ ] 25. Implement MCP server
  - [ ] 25.1 Create MCP server and protocol handling
  ...
  - [ ] 25.2 Implement MCP tool and prompt registration
  ...
  - [ ] 25.3 Implement MCP authentication
...
- [ ] 26. Implement security and input validation
  - [ ] 26.1 Implement query sanitization
    - _Skills: `security-audit`, `typescript-expert`_
...
- [ ] 27. Implement privacy and embedding handling
  - [ ] 27.1 Ensure local-only code processing
    - _Skills: `security-audit`, `typescript-expert`_
...
- [ ] 28. Integration and end-to-end wiring
  - [ ] 28.1 Wire CLI to indexing pipeline
